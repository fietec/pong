...
var ASM_CONSTS = {
  94646: () => { if (document.fullscreenElement) return 1; },  
 94692: () => { return Module.canvas.width; },  
 94724: () => { return parseInt(Module.canvas.style.width); },  
 94772: () => { document.exitFullscreen(); },  
 94799: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 94871: () => { if (document.fullscreenElement) return 1; },  
 94917: () => { return Module.canvas.width; },  
 94949: () => { return screen.width; },  
 94974: () => { document.exitFullscreen(); },  
 95001: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 95195: () => { return window.innerWidth; },  
 95221: () => { return window.innerHeight; },  
 95248: () => { if (document.fullscreenElement) return 1; },  
 95294: () => { return Module.canvas.width; },  
 95326: () => { return parseInt(Module.canvas.style.width); },  
 95374: () => { if (document.fullscreenElement) return 1; },  
 95420: () => { return Module.canvas.width; },  
 95452: () => { return screen.width; },  
 95477: () => { return window.innerWidth; },  
 95503: () => { return window.innerHeight; },  
 95530: () => { if (document.fullscreenElement) return 1; },  
 95576: () => { return Module.canvas.width; },  
 95608: () => { return screen.width; },  
 95633: () => { document.exitFullscreen(); },  
 95660: () => { if (document.fullscreenElement) return 1; },  
 95706: () => { return Module.canvas.width; },  
 95738: () => { return parseInt(Module.canvas.style.width); },  
 95786: () => { document.exitFullscreen(); },  
 95813: ($0) => { Module.canvas.style.opacity = $0; },  
 95851: () => { return screen.width; },  
 95876: () => { return screen.height; },  
 95902: () => { return window.screenX; },  
 95929: () => { return window.screenY; },  
 95956: () => { return window.devicePixelRatio; },  
 95992: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 96045: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 96096: () => { Module.canvas.style.cursor = 'none'; },  
 96133: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 96389: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 96440: () => { if (document.pointerLockElement) return 1; },  
 96487: () => { if (document.fullscreenElement) return 1; },  
 96533: () => { return window.innerWidth; },  
 96559: () => { return window.innerHeight; }
};
